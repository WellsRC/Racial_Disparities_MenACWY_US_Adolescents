...
load('NIS_Teen_Model_Selection_All_Races.mat','Model_Summary');

Model_Summary=sortrows(Model_Summary,width(Model_Summary),'descend');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Generate Sample
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
mdl=cell(5,1);
for mm=1:5    
    MV=[Var(table2array(Model_Summary(mm,2:5))) Income_Var(Model_Summary.Income_Poverty_Ratio(mm))];
...
% 
% VIF_X=[Num_IPR Num_Yr_Report(:,2:end) Num_Region(:,2:end) Num_Race(:,1) Num_Mother_Eduction(:,2:end)];
% xx=[1:size(VIF_X,2)];
...
% end
% 
% VIF_Variable={'Income_Poverty_Ratio'; 'Year_2019'; 'Year_2020'; 'Year_2021'; 'Year_2022'; 'Region_2'; 'Region_3'; 'Region_4'; 'Region_5'; 'Region_6'; 'Region_7'; 'Region_8'; 'Region_9'; 'Region_10'; 'Race_White'; 'College_Graduate';'Less_than_12_Years';'More_than_12_years_non_collge_grad'};
% 
% VIF_Table=table(VIF_Variable,VIF);
% 
% save('VIF_Dropout.mat','VIF_Table','mdl');