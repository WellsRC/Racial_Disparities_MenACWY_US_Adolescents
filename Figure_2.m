...
% At least one dose
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
f1=figure('units','normalized','outerposition',[0 0.05 0.35 1]);
 ax1=usamap("all");
for jj=1:3
...
% Color bar
cb1=subplot('Position',[0.815,0.7,0.02,0.28]);
...
% Color bar
subplot('Position',[0.815,0.015,0.02,0.28]);
...
for rn=1:10
    text(ax3(1),pos(rn,1),pos(rn,2),num2str(rn),'HorizontalAlignment','center','VerticalAlignment','middle','Color',bt3(rn,:),'Fontsize',14,'FontWeight','bold');
    text(ax2(1),pos(rn,1),pos(rn,2),num2str(rn),'HorizontalAlignment','center','VerticalAlignment','middle','Color',bt2(rn,:),'Fontsize',14,'FontWeight','bold');
    text(ax1(1),pos(rn,1),pos(rn,2),num2str(rn),'HorizontalAlignment','center','VerticalAlignment','middle','Color',bt1(rn,:),'Fontsize',14,'FontWeight','bold');
end

text(ax3(2),0.5,0.6,'10','HorizontalAlignment','center','VerticalAlignment','middle','Color',bt3(10,:),'Fontsize',14,'FontWeight','bold','Units','Normalized');
text(ax2(2),0.5,0.6,'10','HorizontalAlignment','center','VerticalAlignment','middle','Color',bt2(10,:),'Fontsize',14,'FontWeight','bold','Units','Normalized');
text(ax1(2),0.5,0.6,'10','HorizontalAlignment','center','VerticalAlignment','middle','Color',bt1(10,:),'Fontsize',14,'FontWeight','bold','Units','Normalized');

text(ax3(3),0.5,0.25,'9','HorizontalAlignment','center','VerticalAlignment','middle','Color',bt3(9,:),'Fontsize',14,'FontWeight','bold','Units','Normalized');
text(ax2(3),0.5,0.25,'9','HorizontalAlignment','center','VerticalAlignment','middle','Color',bt2(9,:),'Fontsize',14,'FontWeight','bold','Units','Normalized');
text(ax1(3),0.5,0.25,'9','HorizontalAlignment','center','VerticalAlignment','middle','Color',bt1(9,:),'Fontsize',14,'FontWeight','bold','Units','Normalized');
